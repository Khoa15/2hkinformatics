<?php
if(!isset($_SESSION['id']) || !isset($_SESSION['permission']) || empty($_SESSION['id']) || empty($_SESSION['permission']) || $_SESSION['permission'] < 2 ){
  header('Location: /');
}
if($_SESSION['permission'] < 5){
  header('Location: /admin/product/list.html');
}
...
<body class="">
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <!-- End Navbar -->
      <?php require_once('sites/home2.php') ?>
      <footer class="footer">
...
var month = [];
    ...
    function income(year=new Date().getFullYear()){
      var valofmonth = []
      $.post('/admin/shop/allincome.html', function(o){
        for (var i = 1; i <= 12; i++) {
          valofmonth.push(Number(o[year][i]))
        }
        if(o.sts==1){
          console.log(month)
          console.log(valofmonth)
            ...
            type: 'bar',
              data: {
                  ...
                  datasets: [{
                      label: 'Doanh Thu',
                      data: valofmonth,
                      backgroundColor: 'rgba(83, 142, 237, 1)',
