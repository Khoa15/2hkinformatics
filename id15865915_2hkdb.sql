...
CREATE TABLE `address` (
  ...
  `nbp` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `products` (
  ...
  `actived` tinyint(1) NOT NULL,
  `fcity` varchar(110) COLLATE utf8_unicode_ci NOT NULL,
  `freeship` tinyint(1) NOT NULL DEFAULT 0,
  `bfrom` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `discount` text COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `spcart` (
  ...
  `product_id` int(255) NOT NULL,
  `typepid` text COLLATE utf8_unicode_ci NOT NULL,
  `store_id` int(255) NOT NULL,
...
CREATE TABLE `system` (
  ...
  `nbp` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
